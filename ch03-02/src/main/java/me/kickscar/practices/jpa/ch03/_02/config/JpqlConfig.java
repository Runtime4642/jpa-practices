package me.kickscar.practices.jpa.ch03._02.config;
...
@ComponentScan( basePackages = { "me.kickscar.practices.jpa.ch03._02.repository" })
public class JpqlConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        // 엔티티(@Entity) 탐색 시작 위치
        em.setPackagesToScan(new String[] { "me.kickscar.practices.jpa.ch03._02.domain" });
        // 하이버네이트 구현체 사용
