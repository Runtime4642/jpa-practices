...
import me.kickscar.practices.jpa.ch03._02.dto.GuestbookDto;
...
public class JpqlGuestbookRepository {
    ...
    public List<GuestbookDto> findAll2(){
        String qlString = "select new me.kickscar.practices.jpa.ch03._02.dto.GuestbookDto(gb.no, gb.name, gb.contents, gb.regDate) from Guestbook gb order by gb.regDate desc";
