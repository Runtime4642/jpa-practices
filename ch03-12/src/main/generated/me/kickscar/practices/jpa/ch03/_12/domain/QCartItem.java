...
public class QCartItem extends EntityPathBase<CartItem> {
    ...
    private static final long serialVersionUID = 1333733219L;
    ...
    public final QCartItemId catrtItemId;
    ...
    public QCartItem(Class<? extends CartItem> type, PathMetadata metadata, PathInits inits) {
        ...
        this.catrtItemId = inits.isInitialized("catrtItemId") ? new QCartItemId(forProperty("catrtItemId")) : null;
